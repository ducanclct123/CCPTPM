    ...
    const handleOkUser = async (values) => {
        ...
        try {
            ...
            return assetCategoryApi.createAssetCategory(categoryList).then(response => {
                if (response.error == "Tên loại danh mục đã tồn tại.") {
                    setLoading(false);
                    return notification["error"]({
                         message: `Thông báo`,
                         description:
                             'Tên loại danh mục đã tồn tại.',
                ...
                if (response === undefined) {
                    notification["error"]({
                        message: `Thông báo`,
                        description:
                            'Tạo danh mục danh mục thất bại',
                    });
                }
                else {
            ...
            return assetCategoryApi.updateAssetCategory(categoryList, id).then(response => {
                ...
                if (response === undefined) {
                    notification["error"]({
                        message: `Thông báo`,
                        description:
                            'Chỉnh sửa danh mục danh mục thất bại',
                    });
                }
                else {
                    notification["success"]({
                        message: `Thông báo`,
                        description:
                            'Chỉnh sửa danh mục danh mục thành công',
                    });
                    handleCategoryList();
            ...
            await assetCategoryApi.deleteAssetCategory(id).then(response => {
                ...
                if (response === undefined) {
                    notification["error"]({
                        message: `Thông báo`,
                        description:
                            'Xóa danh mục danh mục thất bại',
                    ...
                    notification["success"]({
                        message: `Thông báo`,
                        description:
                            'Xóa danh mục danh mục thành công',
                ...
                <div>
                    <Row>
                        ...
                        <div
                            style={{ marginLeft: 10 }}>
                            <Popconfirm
                                title="Bạn có chắc chắn xóa danh mục danh mục này?"
    ...
    return (
        <div>
            <Spin spinning={loading}>
                ...
                <Modal
                    title="Chỉnh sửa danh mục danh mục"
