...
import { Card, Divider, Form, Button, notification } from "antd";
import {
    UserOutlined,
    LockOutlined,
    PhoneOutlined,
                    ...
                    <Card id="dialog" bordered={false}>
                        ...
                        >
                            ...
                            >
                                <Input
                                    prefix={
                                        <UserOutlined className="siteformitemicon" />
                                    }
                            ...
                            >
                                <Input
                                    prefix={
                                        <LockOutlined className="siteformitemicon" />
                                    }
                                    type="password"
                            ...
                            >
                                <Input
                                    prefix={
                                        <MailOutlined className="siteformitemicon" />
                                    }
                                    placeholder="e-mail!"
                                />
                            </Form.Item>
                            ...
                            >
                                <Input
                                    prefix={
                                        <PhoneOutlined className="siteformitemicon" />
                                    }
